...
本目录放 tutorial，不放正式决策。Tutorial 的目标是让人或 Agent 能完成一个具体动作：理解一个 repo、更新一个索引、维护 Factor contract、整理一批资料。
...
| [Factor Lab](factor-lab.md) | 要维护 Python Factor contract 草案 | `AbstractFactor`、spec、examples、tests |
| [Official Factors](official-factors.md) | 要维护稳定 Python OfficialFactor contract | `OfficialFactor`、官方 schema、canonical examples |
