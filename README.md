...
- 静态 Skill 如何在 EvoZeus 调度下留下 feedback、design doc、PR、CHANGELOG、release 和 preflight 闭环。
...
| 维护 EvoZeus 调度的静态 Skill wrapper / 演进 harness | `10-repos/EvoZeus-wrapper` |
...
EvoZeus-MegaRepo
  ...
  -> EvoZeus-wrapper        EvoZeus-orchestrated static SKILL wrapper harness
